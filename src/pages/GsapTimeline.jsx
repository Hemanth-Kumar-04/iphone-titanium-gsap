...
import gsap from "gsap"; // Import gsap, not gsap-core

const GsapTimeline = () => {
  useGSAP(); // Call the useGSAP hook directly within the component body

  useEffect(() => {
    // Define your GSAP timeline inside useEffect
    ...
    // Cleanup function to clear the timeline on component unmount
    return () => {
      timeline.kill(); // Stop and clear the timeline
    };
  }, []);
  return (
    <main>
